...
struct ExamplesDefaults {
    ...
    static func chartFrame(_ containerBounds: CGRect, y : CGFloat) -> CGRect {
        return CGRect(x: 0, y: y, width: containerBounds.size.width + 70, height: containerBounds.size.height / 2.5)
    }
